    ...
    return (
        <div className="container mt-4">
            <div className="card shadow p-4">
                ...
                <Dialog visible={productDialog} style={{ width: '30rem', paddingBottom: '0' }} header={`${tipoArticulo ? 'Editar' : 'Nuevo'} Tipo de Ubicación`} modal className="p-fluid" onHide={hideDialog}>
                ...
                <Dialog visible={deleteProductsDialog} style={{ width: '30rem' }} header="Confirmación" modal footer={deleteProductsDialogFooter} onHide={() => setDeleteProductsDialog(false)}>
                    <div className="p-d-flex p-ai-center p-p-3">
                        ...
                        {tipoArticulo && (
                            <span>¿Seguro que quieres eliminar el tipo de ubicación <b>{tipoArticulo.nombre}</b>?</span>
                        )}
                    </div>
                </Dialog>
            </div>
